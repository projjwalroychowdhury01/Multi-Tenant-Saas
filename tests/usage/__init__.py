...
from tests.factories import MembershipFactory, OrganizationFactory, PlanFactory, UserFactory
...
def PlanFactory(**kwargs):
    """Factory function to create a Plan with default values."""
    defaults = {
        "name": "Test Plan",
        "slug": kwargs.get("slug", f"test-{hash(str(kwargs)) % 10000}"),
        "price_monthly": 0,
        "limits": {"api_calls_per_month": 1000},
        "features": {},
        "is_active": True,
